  ...
  <el-row class="container">
    <el-col :span="24" class="header">        
      <el-col :span="10" class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
            <router-link to="/strategyList" style='text-decoration: none;color: #FFFFFF;'>{{collapsed?'':sysName}}</router-link>
      </el-col>
      <el-col :span="10">
      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover"><!--<img :src="this.sysUserAvatar"-->
          <span class="el-dropdown-link userinfo-inner"><img src="../assets/userphoto.jpg"/> {{sysUserName}}</span>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
                <router-link :to="{name: '个人中心'}" style='text-decoration: none;color: #000000;'>我的消息</router-link>
            </el-dropdown-item>
            <el-dropdown-item> 
            <router-link :to="{name: '个人中心'}" style='text-decoration: none;color: #000000;'>我的设置</router-link>
            </el-dropdown-item>
