<template>
    <section>
        ...
        <el-table :data="Case" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="caseName" label="实验名称" min-width="20%" sortable show-overflow-tooltip>
            ...
            <el-table-column prop="user_name" label="创建人" min-width="10%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="updateTime":formatter="formatTime" label="更新日期" min-width="15%" sortable show-overflow-tooltip>
            </el-table-column>
...
<script>
    import { test, addCase, updateCase } from '../../../api/api'
    import $ from 'jquery'
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.code === '999999') {
                                ...
                                self.$router.push({ name: '分组实验列表', params: { project_id: self.$route.params.project_id, firstGroup: self.updateGroupForm.firstGroup}});
                            }
                            else {
                                self.$message.error({
                                    message: data.msg,
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            updateCase(header, param).then(_data => {
                ...
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        ...
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            addCase(header, params).then(_data => {
                                let {msg, code, data} = _data;
