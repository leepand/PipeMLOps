<template>
	<section>
		...
		<el-table :data="api" highlight-current-row v-loading="listLoading"
			...
			<el-table-column prop="LastUpdateTime":formatter="formatTime" label="更新日期" min-width="15%" sortable show-overflow-tooltip>
			</el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getApiList() {
                ...
                $.ajax({
                    type: "get",
                    url: test+"/api/serving/service_total",///api/api/api_list
                    async: true,
                    data: param,
                    headers: {
                        Authorization: 'Token '+JSON.parse(sessionStorage.getItem('token'))
