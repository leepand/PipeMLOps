<template>
    <div style="margin:35px">
        ...
        <el-table :data="project" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="name" label="服务名称" min-width="15%" sortable show-overflow-tooltip>
            ...
            <el-table-column prop="servingIP" label="Serving IP" min-width="28%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="description" label="模型描述" min-width="27%" sortable show-overflow-tooltip>
            </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" style="width: 60%; left: 20%">
            <el-form :model="editForm"  :rules="editFormRules" ref="editForm" label-width="80px">
                ...
                <el-form-item label="Host" prop='servingIP'>
                    <el-input v-model.trim="editForm.servingIP" auto-complete="off"></el-input>
                </el-form-item>
...
<script>
    ...
    import { getModelService, delHost, disableHost, enableHost,
    ...
    export default {
        ...
        methods: {
            ...
            getGlobalHost() {
                ...
                getModelService(headers, params).then(_data => {
